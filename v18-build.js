...
inject(indexFile, '/launch-v22.css', '<link rel="stylesheet" href="/launch-v22.css?v=30.0">');
inject(indexFile, '/launch-v22.js', '<script src="/launch-v22.js?v=30.0"></script>', 'body');
replaceIn(indexFile, '/launch-v22.css?v=29.0', '/launch-v22.css?v=30.0');
replaceIn(indexFile, '/launch-v22.js?v=29.0', '/launch-v22.js?v=30.0');
...
for (const name of ['panel.html','content-admin.html']) {
  ...
  inject(f, '/admin-v22.js', '<script src="/admin-v22.js?v=30.0"></script>', 'body');
  replaceIn(f, '/admin-v22.js?v=22.0', '/admin-v22.js?v=30.0');
